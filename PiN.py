...
admin_target = 'Admin_1: States/Regions'#'Admin_2: Regions' 
pop_group_var = 'pop_group'
...
excel_path = 'input/MSNA_clean_data_hoh_update_V1_3.xlsx'
...
severity_4_matches = find_matching_choices(choices, selected_severity_4_barriers, label_var=label_var)
severity_5_matches = find_matching_choices(choices, selected_severity_5_barriers, label_var=label_var)
