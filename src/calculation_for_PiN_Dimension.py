...
def calculatePIN (country, edu_data, household_data, choice_data, survey_data, ocha_data,mismatch_ocha_data,
    ...
    host_suggestion = ["Non displaced household","Hote","Urban","PND",'host_community',"always_lived","general_pop",'non_deplace','Host Community',"Host community members",'host_communi', "always_lived","non_displaced_vulnerable",'host',"non_pdi","hote","menage_n_deplace","resident","lebanese","Populationnondéplacée","ocap","non_deplacee","Residents","yes","4"]
    IDP_suggestion = ["Internally displaced persons (IDP)","PDI_FA",'host_family','idp_host', 'PDI',"Rural","displaced","IDP", 'pdi_famille','New IDPs','pdi', 'idp', 'idp_host' ,"menage_deplace_interne", 'Out-of-camp','no',  'pdi_fam', '2', '1' ]
